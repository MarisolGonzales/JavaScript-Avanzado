...
function mostrarPerfil(perfil) {
    ...
    document.querySelector("#salidaContacto").textContent = `${perfil.correo} | ${perfil.telefono}`;
    document.querySelector("#salidaBiografia").textContent = perfil.biografia || "Sin biografía registrada.";
